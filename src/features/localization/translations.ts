...
export const TRANSLATIONS: TranslationCatalog = {
  zh: {
    ...
    // 添加轨迹弹窗
    'add.title': '添加 KML 轨迹',
    'add.description': '导入路线文件或恢复项目备份。',
    'add.dropPrimary': '选择或拖入 KML / ZIP',
    'add.dropSecondary': '可一次选择多个文件',
    'add.dropHint': '拖入或点击选择 .kml / .zip 文件（可多选，支持导入前导出的 KML 打包）',
    'add.parsing': '⏳ 解析',
    'add.waypoints': '标注点',
    'add.urlPlaceholder': '可选：粘贴轨迹来源链接',
    'add.projectRestore': '恢复完整项目',
    'add.projectRestoreDesc': '恢复轨迹、行程与标注',
  ...
  en: {
    ...
    'add.description': 'Import route files or restore a project backup.',
    'add.dropPrimary': 'Choose or drop KML / ZIP',
    'add.dropSecondary': 'Select multiple files at once',
    ...
    'add.projectRestoreDesc': 'Restore trails, itinerary, and waypoints',
