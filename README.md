...
| 标注管理 | 自动分类、筛选、改名和手动添加营地、垭口、水源、补给等标注 |
| 下撤方案 | 选择 A/B 点建立下撤路线，并在地图与行程侧栏中检查 |
...
- 桌面端以七项侧栏提供高频操作和路线上下文。
- 移动端以五项底栏保留拇指可达的核心命令，低频操作进入更多菜单或 bottom sheet。
- 路线库、主轨迹摘要、行程与下撤视图位于响应式侧栏；海拔分析坞可折叠。
